    ...
    <div className="flex flex-col min-h-screen bg-gray-50 items-center justify-center p-4">
      <div className="w-full max-w-sm bg-white rounded-2xl shadow-xl overflow-hidden">
        <div className="bg-red-500 p-6 text-center">
          ...
          <p className="text-red-100 text-sm mt-1">Login to your account to continue</p>
        </div>
        ...
        <form onSubmit={handleLogin} className="p-6 space-y-4">
          ...
          <div className="space-y-1">
            <label className="text-sm border-gray-600 font-medium text-gray-700">Email Address</label>
